...
//        $data = arrayTool::removeFirst($data);
    ...
    {
        if (file_exists(FILE_DB_PATH . $tableName . "." . FILE_DB_POSTFIX)) {
            if (unlink(FILE_DB_PATH . $tableName . "." . FILE_DB_POSTFIX)) {
    ...
    {
        return file_exists(FILE_DB_PATH . $tableName . "." . FILE_DB_POSTFIX)?"yes":"no";
    }
